...
Public RSc As New Recordset
Public RSJO As New Recordset
...
'Set RS = New ADODB.Recordset
        ...
        RS.Update
        RS.Close
        MsgBox "RECORD MOVED TO PAID BILL SECTION"
        load
End Sub
...
SQL = "SELECT * FROM [" & "USSC" & "]  where [" & "Serviceno" & "]" & "LIKE '%" & Text13.Text & "%' and PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "NOT DONE" & "'"
ElseIf Combo1.Text = "Vehicle No" Then
SQL = "SELECT * FROM [" & "USSC" & "]  where [" & "VNo" & "]" & "LIKE '%" & Text13.Text & "%' and PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "NOT DONE" & "'"
ElseIf Combo1.Text = "Customer Name" Then
SQL = "SELECT * FROM [" & "USSC" & "]  where [" & "NOC" & "]" & "LIKE '%" & Text13.Text & "%' and PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "NOT DONE" & "'"
End If
'Set RS = New ADODB.Recordset
 RS.Open SQL, Connect, adOpenStatic, adLockOptimistic, adCmdText
    'AddFields
...
List1.Clear
List2.Clear
SQL = "SELECT * FROM USSC WHERE PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "NOT DONE" & "'"
'Set RS = New ADODB.Recordset
 RS.Open SQL, Connect, adOpenStatic, adLockOptimistic, adCmdText
   Do While Not RS.EOF
      List1.AddItem RS!ServiceNo
...
'Set RSJO = New ADODB.Recordset
 RSJO.Open SQL, Connect, adOpenStatic, adLockOptimistic, adCmdText
   Do While Not RSJO.EOF
      List3.AddItem RSJO!TypeVehicle
    RSJO.MoveNext
    Loop
  RSJO.Close
End Sub
...
SQL = "SELECT * FROM USSC where Serviceno='" & List1.Text & "' and VNo='" & List2.Text & "'"
'Set RS = New ADODB.Recordset
 RS.Open SQL, Connect, adOpenStatic, adLockOptimistic, adCmdText
    Text10 = RS!ServiceNo
