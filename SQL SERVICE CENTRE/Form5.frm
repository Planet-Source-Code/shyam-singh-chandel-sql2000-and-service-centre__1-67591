...
Private Sub Command6_Click()
        ...
        RS.Update
        MsgBox "RECORD HAS BEEN MOVED TO NOT PAID BILL SECTION"
        load
End Sub
...
SQL = "SELECT * FROM [" & "USSC" & "]  where [" & "Serviceno" & "]" & "LIKE '%" & Text13.Text & "%' and PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "DONE" & "'"
ElseIf Combo1.Text = "Vehicle No" Then
SQL = "SELECT * FROM [" & "USSC" & "]  where [" & "VNo" & "]" & "LIKE '%" & Text13.Text & "%' and PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "DONE" & "'"
ElseIf Combo1.Text = "Customer Name" Then
SQL = "SELECT * FROM [" & "USSC" & "]  where [" & "NOC" & "]" & "LIKE '%" & Text13.Text & "%' and PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "DONE" & "'"
End If
Dim RS As New Recordset
 RS.Open SQL, Connect, adOpenStatic, adLockOptimistic, adCmdText
...
List2.Clear
Dim SQL As String
SQL = "SELECT * FROM USSC WHERE PRINTBILL='" & "DONE" & "' AND PRINTSTATUS='" & "DONE" & "' AND PAYMENTSTATUS='" & "DONE" & "'"
Dim RS As New Recordset
 RS.Open SQL, Connect, adOpenStatic, adLockOptimistic, adCmdText
   Do While Not RS.EOF
      List1.AddItem RS!ServiceNo
